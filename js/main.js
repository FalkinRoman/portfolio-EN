...
$(window).on('beforeunload', function(){
  ...
  function Upstatement() {
    ...
    document.getElementById('text-onclick1').innerHTML='Backend developer on Laravel';
    document.getElementById('text-onclick1-1').innerHTML=' @ 5G Store';
    document.getElementById('text-onclick2').innerHTML='October - December 2023';
    document.getElementById('text-onclick3-1').innerHTML='Creation and support of server infrastructure, interaction with databases, development of site business logic';
    document.getElementById('text-onclick3-2').innerHTML='Integration with external services, performance optimization, API development, as well as application security';
    document.getElementById('text-onclick3-3').innerHTML='Created and configured an administrative panel for the online store, providing convenient management of store content and data.';
  ...
  function scout() {
    ...
    document.getElementById('text-onclick3-1').innerHTML='Software development both on the client (frontend) and server side (backend)';
    document.getElementById('text-onclick3-2').innerHTML='Creating a user interface (UI) using markup languages (HTML), styles (CSS) and scripts (JavaScript)';
    document.getElementById('text-onclick3-3').innerHTML='Using the Laravel backend framework for interaction between the server and client parts.';
  ...
  function apple() {
    ...
    document.getElementById('text-onclick3-1').innerHTML='Layout using HTML and CSS, development of interactive elements using JavaScript';
    document.getElementById('text-onclick3-2').innerHTML='Integration of design into functional user interfaces, ensuring cross-browser compatibility and adaptability';
    document.getElementById('text-onclick3-3').innerHTML='Code debugging to ensure a high level of functionality and quality user experience.';
